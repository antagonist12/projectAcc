                        ...
                        <div class="row no-gutters">
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Harga Pokok : <?= $produk['harga_pokok']; ?></p>
                                    <p class="card-text">Harga Jual : <?= $produk['harga_jual']; ?></p>
                                    <p class="card-text">Stok Tersedia : <?= $produk['stok']; ?></p>
                                    <p class="card-text">Keterangan : <?= $produk['keterangan']; ?></p>
                                    <img class="img-fluid" src="img/produk/<?= $produk["gambar"]; ?>" width="100px;"></td>
                                    <br>
                                    <br>
                                    <a href="produk.php" class="badge badge-dark">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
