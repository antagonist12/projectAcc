...
if (isset($_POST['tambah'])) {
    ...
    if (tambahreturpenjualan($_POST) > 0) {
        echo "<script> alert('Retur Penjualan Berhasil Di Tambah'); </script>";
        echo "<script>location='returPenjualan.php';</script>";
    } else {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Retur Penjualan</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tglRetur" name="tglRetur" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="namaproduk">Pilih Produk Yang Ingin Di Retur</label>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label for="jenis-retur">Jenis Retur</label>
                                            <select class="custom-select mr-sm-2" id="jenis_retur" name="jenis_retur" required>
                                                <option disabled selected>Pilih Jenis Retur</option>
                                ...
                                <button type="submit" class="btn btn-primary" name="tambah">Tambah Retur Penjualan</button>
                                <a href="returPenjualan.php" class="btn btn-warning">Kembali</a>
                            </form>
                        </div>
