                        ...
                        <div class="col-lg-8 mb-4">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namaproduk" placeholder="Enter Name" name="nama" required>
                                </div>

                                <div class="form-group">
                                    <label for="harga">Harga Pokok</label>
                                    <input type="text" class="form-control" id="hargaPokok" placeholder="Enter Price" name="hargaPokok" required>
                                </div>

                                <div class="form-group">
                                    <label for="harga">Harga Jual</label>
                                    <input type="text" class="form-control" id="hargaJual" placeholder="Enter Price" name="hargaJual" required>
                                </div>

                                <div class="form-group">
                                    <label for="stok">Stok</label>
                                    <input type="text" class="form-control" id="stok" placeholder="Enter Stock" name="stok" required>
                                </div>
